...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml','launch/object_detection_launch.py']),
    ...
    zip_safe=True,
    maintainer='imad',
    maintainer_email='imad.el-bouazzaoui@expleogroup.com',
    description='YOLOv7 ROS2 Package for Object Detection',
